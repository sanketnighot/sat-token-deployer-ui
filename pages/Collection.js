            ...
            <div className="container min-h-24 w-full md:w-3/6 p-8">
                ...
                <form
                    ...
                    <div className="flex-row justify-center md:flex text-center">
                        <p className="md:text-left md:ml-4 text-sm md:text-xl mb-6 font-seven md:w-2/6 m-1">1. Define your collection name</p>
                        <input
                    ...
                    <div className="flex-row justify-center md:flex text-center">
                        <p className="md:text-left md:ml-4 text-sm md:text-xl font-seven mb-4 md:w-2/6 m-1">3. Describe your token in few words</p>
                        <textarea
