            ...
            <div className="container min-h-24 w-full md:w-3/6 p-8">
                ...
                <div className="border-2 border-[#39FF14] ring-2 ring-[#39FF14] shadow-lg p-5">
                    ...
                    <div className="flex-row justify-center md:flex text-center">
                        ...
                        <button className="text-sm md:text-xl font-seven mb-4 border-2 border-green-300 ring-2 ring-green-700 shadow-lg md:w-full w-full mx-2 px-4 py-1 bg-green-900 hover:bg-[#a2ff00] text-[#a2ff00] hover:text-green-900">
                            Create SAT Token
                        </button>
                    </div>
                </div>
